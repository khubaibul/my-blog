    ...
    return (
        <div className='my-10'>
            ...
            <div 
                ...
                className='bg-cover bg-center bg-fixed h-[600px] w-full'
            >
            <div className='h-[600px] w-full backdrop-brightness-50 bg-bgColor/10 text-white'>
                <h2 className='uppercase text-center text-4xl font-bold font-titleFont tracking-wider pt-28'>Support Me</h2>
                <div className='flex items-center justify-center w-2/3 mx-auto gap-x-10 text-center pt-16'>
                    <div className='h-48 flex flex-col items-center justify-between gap-y-4'>
